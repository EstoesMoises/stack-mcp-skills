...
- If the approved call fails or lacks confirmation, preserve the approved payload and report that no draft or question was confirmed. Require explicit approval again after any retry-relevant change.
