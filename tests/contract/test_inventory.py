...
EXPECTED_SKILLS = {"efficient-search", "company-debugging", "capture-quality-qa", "onboarding", "find-sme", "incident-to-knowledge", "fill-knowledge-gap", "review-stale-content", "triage-unanswered"}
